...
import queue
from server.queue import queue_check, queue_wait_for_input
from autogpt.prompt import construct_prompt_goals
...
class Agent:
    ...
    def __init__(
        ...
        self.full_message_history_retry= []
    ...
    def start_interaction_loop(self):
        ...
        while True:
            ...
            with Spinner("Thinking... "):
                result = actions["thinking"](self.cid)

                #ADD check if goal or someting ghanged
                queue_check(self.queue)
                #ADD for prompt update each time
                system_prompt = construct_prompt_goals(self.goals)
            ...
            if assistant_reply_json != {}:
                ...
                try:
                    ### Action
                    result = actions["thoughts"](self.cid,assistant_reply_json)
            ...
            if not cfg.continuous_mode and self.next_action_count == 0:
                ...
                while True:
                    #ADD remote mode
                    if self.cid != "":
                        console_input = queue_wait_for_input(self.queue)
                    else:
                    ...
                    if console_input.lower().strip() == "y":
                        ...
                        break
                    if console_input.lower().strip() == "r":
                        user_input = "RETRY"
                        break
                ...
                if user_input == "RETRY":
                    ...
                    self.full_message_history=self.full_message_history_retry.copy()
