...
def run_auto_gpt(
    ...
    if workspace_directory is None:
        ...
        workspace_directory = Path(f"workspace_directory/{cid}")
    ...
    file_logger_path = workspace_directory / f"file_logger.txt"
    ...
    system_prompt = ai_config.construct_full_prompt_goals(goals)
